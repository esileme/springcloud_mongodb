...
public abstract class AbstractTokenUtil {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        String key = RedisKey.REDIS_PREFIX_AUTH + userDetails.getUsername();
    ...
    public Boolean validateToken(String token) {
        ...
        String key = RedisKey.REDIS_PREFIX_AUTH + username;
    ...
    protected String getUserDetailsString(String token) {
        final String username = getUsernameFromToken(token);
        String key = RedisKey.REDIS_PREFIX_USER + username;
    ...
    private void putUserDetails(UserDetails userDetails) {
        String key = RedisKey.REDIS_PREFIX_USER + userDetails.getUsername();
