...
public final class Message {
     ...
     * 错误信息
     */
    public static final String RETURN_FIELD_ERROR = "data";
    /**
     * 错误描述
     */
    public static final String RETURN_FIELD_ERROR_DESC = "msg";
    /**
     * 返回数据
     */
     ...
     * HTTP状态码与系统错误代码对应关系
     */
    public static final Map<Integer, Integer> STATUS_CODE_MAP;

    static {
        Map<Integer, Integer> codeMappingMap = new HashMap<>();
